...
class LoginViewController: UIViewController, ICETutorialControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if (showTutorial){
            ...
            var layer0: ICETutorialPage = ICETutorialPage(title: "", subTitle: "", pictureName: "Logo_tutorial", duration: 3.0)
